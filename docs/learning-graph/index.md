# Learning Graph for Measuring GenAI ROI
...
This learning graph covers 561 concepts — above the typical 200-concept target because the
course spans three integrated skill clusters (generative AI/token mechanics, financial/lifecycle
cost analysis, and executive reporting), each of which needed enough depth to stand on its own.
...
- Graph structure validation - all 561 concepts are connected in a single component
- DAG validation (0 cycles detected)
- Foundational concepts: 3 entry points (Artificial Intelligence, Token, Return On Investment)
- Terminal nodes: 96 (17.1%) — within the healthy 5–40% range
...
- Category organization - generative AI/token foundations first, financial/lifecycle cost analysis in the middle, executive reporting and capstone last
- Balanced categories (7.1% - 8.9% each)
- All categories under 30% threshold
- Pedagogical flow recommendations
- Clear 4-5 letter abbreviations for use in the CSV file
- No Miscellaneous (MISC) category was needed — every concept fit a named category
